...
- **Docs version:** v1.1 (2026-08-11)
- **Phase ปัจจุบัน:** ยังไม่เริ่ม — ถัดไปคือ P0 (Infra Spike) ใน session C1
- **Blocker ที่รอ verify:** R-01 (FatSecret IP whitelist บน VPS), R-02 (domain + TLS)
