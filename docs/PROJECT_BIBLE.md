...
| BL-09 | เลื่อนอีกครั้ง 2026-08-21 (วีตัดสินใจตอนปิด P4b ตามที่สัญญาไว้ — แต่เสนอเกณฑ์แทนการเลื่อนลอยๆ) | | Friends tab: streak leaderboard, contribution board (สร้าง/verify custom food), opt-in activity feed — หลักการ: แข่งที่พฤติกรรม ห้ามมี leaderboard น้ำหนัก/kcal, diary ยัง private ตาม RLS เดิม. Toolbar ใหม่เมื่อทั้งสองมา: Dashboard·Diary·Search·Friends·Settings — ลำดับสุดท้ายตัดสินจาก dogfood — **เกณฑ์ตัดสิน (2026-08-21):** BL-12 (ขออาหารใหม่ในแอป) คือ interaction ระหว่าง user ครั้งแรกของระบบ (เพื่อนขอ→วีตอบสนอง→แจ้งกลับ) ถือเป็น prototype ของ Friends ในตัว — วัดผลหลัง BL-12 ใช้จริง 3-4 สัปดาห์: เพื่อนกดขอสม่ำเสมอ = ฟีเจอร์เชิงสังคมมีที่ยืนจริง → ทำ BL-09 เต็ม; แทบไม่มีใครกด = สัญญาณว่า Friends tab ก็จะไม่มีคนใช้เหมือนกัน → ปิด BL-09 ทิ้งได้เลยไม่ต้องเสียดาย |
