...
สะสม |
| BL-14 | **[ถัดไป]** ยังไม่กำหนด phase เต็ม แต่วีระบุให้ทำก่อนรายการอื่น (2026-08-21) | | **In-app
notification badge** — จุดแจ้งเตือนบนแท็บ/ไอคอนเมื่อมีของใหม่ที่เกี่ยวข้องกับ user: คำขออาหารของตัวเอง
เปลี่ยนสถานะ (BL-12) และของอื่นที่จะมาทีหลัง (เช่น feed ข่าวสารของ BL-09 ส่วนที่ 1) — เช็คตอนเปิดแอปเท่านั้น
ไม่ใช้ push — เหตุผล: สำหรับ 3 คนที่เปิดแอปทุกวันอยู่แล้ว badge ตอบโจทย์ ~90% ด้วยต้นทุนแทบศูนย์ (ไม่ต้อง
Web Push บน iOS PWA ที่ไม่น่าเชื่อถือ หรือ Shortcuts Automation ที่ต้องต่อ Shortcut #2 ก่อน) — Web
Push/Shortcuts Automation เก็บไว้ประเมินทีหลังถ้าพบว่า badge ไม่พอ |
